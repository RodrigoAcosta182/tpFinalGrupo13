...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-07-2021 a las 03:03:30
...
INSERT INTO `arrastre` (`Id`, `Descripcion`, `Patente`, `NroChasis`, `Activo`) VALUES
(1, 'Araña', 'AA100AS', '5858222', b'1'),
(2, 'Araña', 'AC125AD', '605737', b'1'),
(3, 'Jaula', 'AC296AS', '882174', b'1'),
(4, 'Jaula', 'AB318AD', '5952872', b'1'),
(5, 'Tanque', 'AB405AG', '583419', b'1'),
(6, 'Granel', 'AA624AS', '852157', b'1'),
(7, 'Tanque', 'AAA420N', '420LG4NTE', b'1');
...
(1, 'Gordo', 'Gordomedov', '125', 'Av. Miami 2012', b'0'),
...
INSERT INTO `mantenimiento` (`Id`, `pVehiculo`, `Importe`, `FechaDesde`, `FechaHasta`, `pService`, `Descripcion`, `Finalizado`) VALUES
(2, 3, '4500', '2021-01-26', '2021-06-30', 2, 'Cambio de aceite', b'1'),
(3, 6, '95000', '2021-06-28', '2021-09-30', 1, 'Cambio de motor', b'1'),
(4, 4, '15000', '2021-06-26', '2021-06-30', 2, 'cambio de cubiertas', b'1'),
(5, 4, '70000', '2021-02-03', '2021-03-10', 2, 'Chasis roto', b'1'),
(6, 4, '9000', '2021-06-27', '2021-06-29', 2, 'emparchar rueda', b'1'),
(7, 3, '15420', '2021-06-30', '2021-07-06', 2, 'Cambio de aceite hidráulico', b'1'),
(8, 3, '1500', '2021-07-12', '2021-07-13', 1, 'Cambio de aceite', b'1'),
(9, 3, '21231', '2021-07-13', '2021-07-14', 1, 'sdfsdf', b'1');
...
(37, 2, 3, '-34.66381879311897', '-58.55287944464416', 17, '1992-10-02', '20:11:41', 500, 500, 500),
(38, 2, 3, '-34.66890155138416', '-58.57745920805664', 19, '2021-07-16', '21:9:12', 100, 100, 100),
(39, 2, 3, '-34.698827024141394', '-58.56509958891601', 19, '2021-07-16', '21:10:30', 50, 1, 1),
(40, 2, 3, '-34.69685114725009', '-58.587758890673825', 19, '2021-07-16', '21:11:29', 100, 100, 100),
(41, 2, 3, '-34.70193187822143', '-58.58947550444336', 19, '2021-07-16', '21:12:5', 100, 200, 200);
...
(2, 'Emiliano', 'Nahuel Ortiz', 'emiortiz2001@gmail.coms', '81dc9bdb52d04dc20036dbd8313ed055', 1, 1, 3),
...
(17, 'Billie Joe', 'Armstrong', 'billiejoe@gmail.com', '81dc9bdb52d04dc20036dbd8313ed055', 1, 1, 14);
...
(3, 1, 'AA123CD', 'L53879558', '53879558', '2010-11-06', 220, b'0', 1, b'0', b'1'),
...
CREATE TABLE `viajes` (
  ...
  `SucursalDestino` varchar(250) NOT NULL,
...
INSERT INTO `viajes` (`Id`, `pUsuario`, `pCliente`, `SucursalOrigen`, `SucursalDestino`, `pVehiculo`, `pArrastre`, `FechaOrigen`, `FechaEstimada`, `KmEstimado`, `CombustibleEst`, `PrecioCombustibleEstimado`, `Precio`, `OtrosGastos`, `Finalizado`, `pFactura`) VALUES
(16, 2, 1, 'Gordo de san blas, Tijuana, MEXICO', 'Flaco de san blas, La perla, Puelto Lico', 3, 1, '2021-07-05', '2021-07-12', 1000, 200, 18000, 21000, '3000', b'1', NULL),
(17, 2, 1, 'Gordito malo', 'gordo bueno', 3, 1, '2021-07-12', '2021-07-19', 1000, 200, 18000, 18300, '300', b'1', NULL),
(18, 2, 1, 'garlopa', 'company', 3, 1, '2021-07-12', '2021-07-20', 123, 25, 2214, 2337, '123', b'1', NULL),
(19, 2, 1, 'any', 'desk', 3, 1, '2021-07-12', '2021-07-14', 1500, 300, 27000, 28500, '1500', b'1', NULL);
...
`viajeId` int(11)
,`SucursalOrigen` varchar(250)
,`SucursalDestino` varchar(250)
,`usuarioId` int(11)
,`clienteId` int(255)
,`vehiculoId` int(255)
,`arrastreId` int(255)
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vviajes`  AS SELECT `v`.`Id` AS `viajeId`, `v`.`SucursalOrigen` AS `SucursalOrigen`, `v`.`SucursalDestino` AS `SucursalDestino`, `u`.`Id` AS `usuarioId`, `cli`.`Id` AS `clienteId`, `veh`.`Id` AS `vehiculoId`, `arr`.`Id` AS `arrastreId`, `v`.`FechaOrigen` AS `fechaOrigen`, `v`.`FechaEstimada` AS `fechaEstimada`, `v`.`Precio` AS `precioViaje`, `v`.`KmEstimado` AS `KmEstimado`, `v`.`CombustibleEst` AS `CombustibleEst`, `v`.`PrecioCombustibleEstimado` AS `PrecioCombustibleEstimado`, `v`.`Precio` AS `Precio`, `v`.`OtrosGastos` AS `OtrosGastos`, concat(`u`.`Nombre`,' ',`u`.`Apellido`) AS `usuario`, concat(`cli`.`Nombre`,'',`cli`.`Apellido`) AS `cliente`, `veh`.`Patente` AS `patenteVehiculo`, `arr`.`Patente` AS `patenteArrastre`, `v`.`Finalizado` AS `Finalizado` FROM ((((`viajes` `v` join `usuario` `u` on(`v`.`pUsuario` = `u`.`Id`)) join `cliente` `cli` on(`cli`.`Id` = `v`.`pCliente`)) join `vehiculo` `veh` on(`veh`.`Id` = `v`.`pVehiculo`)) join `arrastre` `arr` on(`arr`.`Id` = `v`.`pArrastre`)) ;
